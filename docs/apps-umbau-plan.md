...
- 2026-09-16 — Nachtrag Englische Fassung: Texte vom Auftraggeber freigegeben; Sitemap für apps.rautaki.ch (Aufgabe 171 in app-schaufenster, `/sitemap.xml` mit hreflang, in `robots.txt` genannt). Chatbot-Prompt nennt `apps.rautaki.ch/en` mit englischen App-Namen (LANGUAGE RULES, APPS, WEITERE SEITEN; Kontrollfrage 11), Freigabe des Auftraggebers 2026-09-16; Einspielen in n8n nach dem Livegang von `/en`.
