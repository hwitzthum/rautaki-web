// GENERATED from src/content/de/about.ts by scripts/translate-content.ts (DeepL, EN-GB).
...
export const about = {
  metaTitle: "About us",
  metaDescription:
    "Harry Witzthum, founder of Rautaki — AI strategy backed by practical implementation expertise and teaching on CAS programmes.",
  workshopClients: [
    "Hepatitis Schweiz",
  ...
  values: [
    ...
    {
      title: "Action rather than just analysis",
      description:
  ...
  heroLabel: "About us",
  hero: {
    tagline: "Strategy for the age of *Artificial Intelligence*",
    nameHeading: "A word that comes from *far away*",
    brandRautaki: "Rautaki",
    namePara1Mid: "comes from te reo Māori and means",
    brandStrategie: "Strategy",
    namePara2:
    ...
    namePara3: "It is precisely this understanding that we bring to our work.",
    whyHeading: "Why this name?",
    whyPara1:
    ...
    whyPara2Prefix: "The name",
    whyPara2Seg1: "has a subtle twist to it: it contains the letters",
    brandA: "a",
    whyPara2And: "and",
    brandI: "i",
    whyPara2Seg3: "– the initials of",
    brandAI: "Artificial Intelligence",
    whyPara2Seg4:
      ". Strategy and AI go hand in hand. One without the other remains incomplete.",
    portraitAlt: "Harry Witzthum, founder of Rautaki",
    portraitName: "Harry Witzthum",
    portraitRole: "Founder, Rautaki",
  },
  perspective: {
    label: "Perspective",
    heading: "A diversity of perspectives — *at the heart* of our work",
    para1a:
      "A good AI strategy is never developed from a single perspective. It requires technology",
    und: "and",
    para1b: "expertise. Leadership",
    para1c: "staff. Economics",
    para1d: "ethics.",
    para2:
    ...
    items: [
      {
        ...
        body: "Providing clarity before investing — from the initial assessment right through to a sound basis for decision-making.",
      },
      {
        title: "Organisational transformation",
        body: "Embedding AI in structures, processes and culture so that change truly takes root.",
      },
      {
        title: "Workshops and training courses",
        body: "Empowering managers and teams to use AI responsibly and effectively — right through to accredited CAS programmes.",
      },
      {
        title: "Practical implementation",
        body: "Developing and supporting applications that hold up in the day-to-day work of organisations.",
      },
    ],
  },
  approach: {
    ...
    para1: "Not every organisation needs more technology.",
    para2:
    ...
    quote: "We’re here to help you with that.",
  },
  founding: {
    label: "Foundation",
  ...
  workshops: {
    label: "Practice",
    heading: "Workshops with organisations",
    intro:
  ...
  teaching: {
    label: "Teaching",
    heading: "Teaching at universities and institutes",
    intro:
  ...
  valuesSection: {
    label: "Values",
    heading: "Principles that shape our AI consultancy",
  },
  cta: {
